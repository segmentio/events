...
// EnableUnsafeOptimizations may be set to true by a program to enable unsafe
// optimizations that make assumptions about the memory layout of types that
// the compiler generates.
var EnableUnsafeOptimizations = false
